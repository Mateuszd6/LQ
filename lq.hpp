...
#define LINQ_FUCTIONS(CURR_TYPE, TO_TYPE, PREVIOUS_TYPE)                \
    ...
    struct from_t
    {
        ...
        select_t<T, SELECT_TYPE, from_t<ITER>>
        ...
        sort_t<T, from_t<ITER>> unique()
            {
                return sort_t<T, from_t<ITER>>(*this);
            }
    ...
    struct sort_t
    {
        ...
        template<typename SELECT_TYPE>
        select_t<T, SELECT_TYPE, sort_t<T, PREV>>
        select(std::function<SELECT_TYPE(T)> c_select_function)
            {
        ...
        sort_t<T, sort_t<T, PREV>> unique()
            {
                return sort_t<T, sort_t<T, PREV>>(*this);
            }
    ...
    struct take_t
    {
        ...
        template<typename SELECT_TYPE>
        select_t<T, SELECT_TYPE, take_t<T, PREV>>
        select(std::function<SELECT_TYPE(T)> c_select_function)
            {
        ...
        sort_t<T, take_t<T, PREV>> unique()
            {
                return sort_t<T, take_t<T, PREV>>(*this);
            }
    ...
    struct skip_t
    {
        ...
        template<typename SELECT_TYPE>
        select_t<T, SELECT_TYPE, skip_t<T, PREV>>
        select(std::function<SELECT_TYPE(T)> c_select_function)
            {
        ...
        sort_t<T, skip_t<T, PREV>> unique()
            {
                return sort_t<T, skip_t<T, PREV>>(*this);
            }
    ...
    struct select_t
    {
        ...
        template<typename SELECT_TYPE>
        select_t<U, SELECT_TYPE, select_t<T, U, PREV>>
        select(std::function<SELECT_TYPE(T)> c_select_function)
            {
