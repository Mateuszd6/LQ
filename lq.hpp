...
struct from_t
{
  ...
  select_t<T, SELECT_TYPE, from_t<ITER>> select(std::function<SELECT_TYPE(T)> c_select_function)
  {
...
struct sort_t
{
  ...
  return_element<T> give_next()
  {
    ...
    return (curr == cache_vector.end() ? return_element<T>(return_state::END)
                                       : return_element<T>(return_state::VALID, *curr++));
  }

  template <typename SELECT_TYPE>
  select_t<T, SELECT_TYPE, sort_t<T, PREV>> select(std::function<SELECT_TYPE(T)> c_select_function)
  {
...
struct where_t
{
  ...
  template <typename SELECT_TYPE>
  select_t<T, SELECT_TYPE, where_t<T, PREV>> select(std::function<SELECT_TYPE(T)> c_select_function)
  {
...
struct take_t
{
  ...
  template <typename SELECT_TYPE>
  select_t<T, SELECT_TYPE, take_t<T, PREV>> select(std::function<SELECT_TYPE(T)> c_select_function)
  {
...
struct skip_t
{
  ...
  template <typename SELECT_TYPE>
  select_t<T, SELECT_TYPE, skip_t<T, PREV>> select(std::function<SELECT_TYPE(T)> c_select_function)
  {
...
struct select_t
{
    ...
    while (1)
      {
        ...
        if (ret.state == return_state::END)
          ...
          return return_element<U>(return_state::VALID, select_function(ret.value));
      }
  }
  ...
  {
    return sort_t<U, select_t<T, U, PREV>>(c_sort_function, sort_method::DEFAULT, *this);
  }
  ...
  sort_t<U, select_t<T, U, PREV>> unique() { return sort_t<U, select_t<T, U, PREV>>(*this); }
