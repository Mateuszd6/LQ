...
{
    {
        ...
        print_with_message("Upcase characters (sorted):", result.begin(), result.end());
    }

    {
        ...
        print_with_message("Numbers < 5 (without the first one): ", result.begin(), result.end());
    }

    {
        ...
        auto result =
            from(numbers.begin(), numbers.end()).where([](auto x) { return x < 5; }).skip(1).sum();
...

    {
        ...
        auto strings = std::vector<std::string_view>{"zero", "one", "two",   "three", "four",
...

    {
        ...
        print_with_message("Stable sorted pairs with 1 as first: ", result.begin(), result.end());
    }
